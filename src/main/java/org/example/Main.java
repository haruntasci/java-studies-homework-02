...
public class Main {
    ...
    public static void adminOperations(Scanner input) {
        ...
        while (flag) {
            ...
            System.out.println("2 - Platform ekle");
            System.out.println("3 - Film ekle");
            System.out.println("0 - Bir önceki sayfaya git");
    ...
    public static void userOperations(Scanner input) {

        boolean flag = true;
        
        while (flag) {
            
            System.out.println("** Kullanıcı sayfası **");
            System.out.println("1 - Kategori Listesi");
            System.out.println("0 - Bir önceki sayfaya git");
            ...
            switch (select) {
                case 1:
                    ...
                    ListFilmsFilteredByCategory(selectedCategoryIndex);
                    break;
                case 0:
                    flag = false;
                    break;
    ...
    public static void ListFilmsFilteredByCategory(int selectedCategoryIndex) {
    ...
    public static void addNewFilm(Scanner input) {
    ...
    public static void addNewCategory(Scanner input) {
    ...
    public static void addNewPlatform(Scanner input) {
